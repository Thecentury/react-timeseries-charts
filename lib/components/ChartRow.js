    ...
    _createClass(ChartRow, [
        ...
        },
        {
            ...
            value: function render() {
                ...
                var innerHeight = +this.props.height - AXIS_MARGIN * 2 + titleHeight;
                ...
                for (
                    ...
                    if (colWidth > 0 && leftColumnIndex < leftAxisList.length) {
                        ...
                        if (_underscore2.default.has(yAxisMap, id)) {
                            transform =
                                "translate(" + (posx + paddingLeft) + "," + titleHeight + ")";
                ...
                if (this.props.trackerTime) {
                    ...
                    var trackerTransform =
                        "translate(" + (leftWidth + paddingLeft) + "," + titleHeight + ")";
                ...
                // Chart title
                var titleTransform = "translate(" + paddingLeft + ",0)";
